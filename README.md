...
* [`docker`](https://docs.docker.com/get-started/ ) may also be required depending on your environment.
...
Ensure the `kubectl get svc` command returns the `kubernetes` service listed.
